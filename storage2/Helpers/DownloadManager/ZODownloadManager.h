...
/// This interface provide methods to handle all media/files download of a client that need to request from remote server or api.
...
///
@interface ZODownloadManager : NSObject
